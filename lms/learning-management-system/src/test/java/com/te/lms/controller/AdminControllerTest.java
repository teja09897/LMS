...
class AdminControllerTest {
	...
	@Test
	public void testUpdateMentor_Return400() throws JsonProcessingException, Exception {
		NewMentorDto mentorDto = NewMentorDto.builder().mentorEmailId("tej123@gmail.com").mentorId("TYO1")
				.mentorName("VIJENDRA").skillsDto(null).build();

		Mockito.when(adminService.updateMentor(Mockito.any())).thenReturn(Optional.ofNullable(null));

		mockMvc.perform(MockMvcRequestBuilders.put("/admin/update/mentor").accept(MediaType.APPLICATION_JSON_VALUE)
				.content(objectMapper.writeValueAsString(mentorDto)).contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(MockMvcResultMatchers.status().isBadRequest());
	}
	...
	@Test
	public void testUpdateBatch_Returns400() throws JsonProcessingException, Exception {
		NewBatchDto batchDto = NewBatchDto.builder().batchId("TYO1").batchName("UPLIFT-SEP-12").mentorName("VIJRNDRA")
				.startDate(LocalDate.of(2022, 9, 12)).endDate(LocalDate.of(2022, 12, 12)).technologiesDto(null).build();

		Mockito.when(adminService.updateBatch(Mockito.any())).thenReturn(Optional.ofNullable(null));
		mockMvc.perform(MockMvcRequestBuilders.put("/admin/update/batch").accept(MediaType.APPLICATION_JSON_VALUE)
				.content(objectMapper.writeValueAsString(batchDto)).contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(MockMvcResultMatchers.status().isBadRequest());
...
//		skillsDtos.add(skillsDto);
	...
	@Test
	public void testDeleteMentor_Return400() throws JsonProcessingException, Exception {
		NewMentorDto mentorDto = NewMentorDto.builder().mentorEmailId("tej123@gmail.com").mentorId("TYO1")
				.mentorName("VIJENDRA").skillsDto(null).build();

		Mockito.when(adminService.deleteMentor(mentorDto.getMentorId())).thenReturn(Optional.ofNullable(null));

		mockMvc.perform(MockMvcRequestBuilders.put("/admin/delete/mentor/TYO1").accept(MediaType.APPLICATION_JSON_VALUE)
				.content(objectMapper.writeValueAsString(mentorDto)).contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(MockMvcResultMatchers.status().isBadRequest());
	}
	...
	@Test
	public void testDeleteBatch_Return400() throws JsonProcessingException, Exception {
		NewBatchDto batchDto = NewBatchDto.builder().batchId("TY01").build();
		Mockito.when(adminService.deleteBatchDetails(batchDto.getBatchId())).thenReturn(Optional.ofNullable(null));
		mockMvc.perform(MockMvcRequestBuilders.put("/admin/delete/batch/TY01").accept(MediaType.APPLICATION_JSON_VALUE)
				.content(objectMapper.writeValueAsString(batchDto)).contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(MockMvcResultMatchers.status().isBadRequest());
	}
	...
	public void testApproveEmployee() throws JsonProcessingException, UnsupportedEncodingException, Exception {
		...
		MessageDto messageDto = MessageDto.builder().employeeEmail("tejavasa@gmail.com").message("this is message")
				.build();
		Mockito.when(adminService.approve(Mockito.any(), Mockito.any())).thenReturn(Optional.ofNullable(messageDto));

		String contentAsString = mockMvc
				.perform(MockMvcRequestBuilders.post("/admin/approve/employee/TY01")
	...
	@Test
	public void testApproveEmployee_Retrns400()
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/admin/approve/employee/TY01")
				.accept(MediaType.APPLICATION_JSON_VALUE).content(objectMapper.writeValueAsString(approveDto))
				.contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(MockMvcResultMatchers.status().isBadRequest());
	}
	...
	public void testRejectEmployee() throws JsonProcessingException, UnsupportedEncodingException, Exception {
		...
		String contentAsString = mockMvc
				.perform(MockMvcRequestBuilders.post("/admin/reject/employee/TY01")
	...
	@Test
	public void testRejectEmployee_Returns400() throws UnsupportedEncodingException, Exception {
		RejectDto rejectDto = RejectDto.builder().reason("rejected").build();
		MessageDto messageDto = MessageDto.builder().employeeEmail("tejavasa@gmail.com").message("this is message")
				.build();
		Mockito.when(adminService.reject(Mockito.any(), Mockito.any())).thenReturn(Optional.ofNullable(null));

		mockMvc.perform(MockMvcRequestBuilders.post("/admin/reject/employee/TY01")
				.accept(MediaType.APPLICATION_JSON_VALUE).content(objectMapper.writeValueAsString(rejectDto))
				.contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(MockMvcResultMatchers.status().isBadRequest());
	...
	@Test
	public void testGetRequestList() throws JsonProcessingException, UnsupportedEncodingException, Exception {
		List<RequestListDto> requestListDtos = Lists.newArrayList();
		RequestListDto requestListDto = new RequestListDto();
		RequestListDto requestListDto2 = new RequestListDto();
		requestListDtos.add(requestListDto);
		requestListDtos.add(requestListDto2);

		Mockito.when(adminService.getRequestList()).thenReturn(Optional.ofNullable(requestListDtos));
	...
	@Test
	public void testGetMentorList() throws Exception {
		...
		newMentorDtos.add(mentorDto2);

		Mockito.when(adminService.mentorList()).thenReturn(Optional.ofNullable(newMentorDtos));
	...
	public void testGetBatchList() throws Exception {
		...
		NewBatchDto batchDto2=new NewBatchDto();
		batchDtos.add(batchDto);
		batchDtos.add(batchDto2);
